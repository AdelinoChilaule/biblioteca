...
class PesquisarAutor extends StatelessWidget {
  final Livro livro;
  final User loggedInUser;
  final String autorPesquisado;

  const PesquisarAutor(this.livro,
      {required this.loggedInUser, required this.autorPesquisado});

  @override
  Widget build(BuildContext context) {
    // Verifica se o autor ou o gênero corresponde ao autor pesquisado
    if (livro.autor != autorPesquisado &&
        livro.genero != autorPesquisado &&
        livro.estado != autorPesquisado &&
        livro.titulo != autorPesquisado) {
      return SizedBox(); // Retorna um SizedBox vazio se o autor e o gênero não corresponderem ao autor pesquisado
    }
